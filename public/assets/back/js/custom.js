...
function ajaxSubmit(a, t, e) {
  if (t.valid()) {
    ...
    $.ajax({
      ...
      success: function (a) {
        a.status
          ? (toastr.success(a.notification),
            "ajaxDeleteForm" === t.attr("class")
              ? $("#alert-modal").modal("toggle")
              : $("#right-modal").modal("hide"),
            e())
          : toastr.error(a.notification);
      },
    });
  } else toastr.error("Please make sure to fill all the necessary fields");
}
