 ...
 <div class="aiz-user-sidenav-wrap position-relative z-1 rounded-0">
    <div class="aiz-user-sidenav overflow-auto c-scrollbar-light px-4 pb-4">
       ...
       <div class="p-4 text-center mb-4 border-bottom position-relative">
          ...
          <img src="https://demo.activeitzone.com/ecommerce/public/uploads/all/5XVyeLGw5zRpb63bqgn2dtIOjCktLgBltNSQIPG3.png" onerror="this.onerror=null;this.src='https://demo.activeitzone.com/ecommerce/public/assets/img/avatar-place.png';">
          </span>
       ...
       <div class="sidemnenu">
          <ul class="aiz-side-nav-list mb-3 pb-3 border-bottom metismenu" data-toggle="aiz-side-menu">
             ...
             <li class="aiz-side-nav-item mm-active">
                <a href="{{route('profile.customer_profile_dashboard')}}" class="aiz-side-nav-link active" aria-expanded="true">
