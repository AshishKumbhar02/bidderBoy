    ...
    <div class="row">
      ...
      <div class="col-md-4 col-12 marg40 col order-last">
        <div class="product_dtt_center">
          <h4>Auction Price <i class="fa fa-inr" aria-hidden="true"></i><span class="bid-price-{{$product->id}}">{{$product->amount_per_bid}}</span></h4>
          <h6>Last  Bidder : </i><span class="bidder-name-{{$product->id}}">{{$product->last_bidder_name}}<span></h6>
        </div>
        <div class="product_bottom_bx">
          ...
          <!-- <button type="button" class="btn btn-info mrgleft10">BID NOW</button> -->
           ...
           <button type="button" class="btn btn-info mrgleft10 bid_now" data-id="{{$product->id}}" data-amount="{{$product->credit_per_bid}}" data-user="{{Auth::user()->id}}" data-token="{{csrf_token()}}">BID NOW</button>
        </div>
      </div>
      ...
      <div class="col-md-12"> 
        <ul class="nav nav-pills" id="pills-tab" role="tablist">
          <li class="nav-item" role="presentation">
            <button class="nav-link active" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home" type="button" role="tab" aria-controls="pills-home" aria-selected="true">Auction</button>
          </li>
          <li class="nav-item" role="presentation">
          ...
          <li class="nav-item" role="presentation">
            <button class="nav-link" id="pills-contact-tab" data-bs-toggle="pill" data-bs-target="#pills-contact" type="button" role="tab" aria-controls="pills-contact" aria-selected="false">Delivery</button>
          </li>
        </ul>
          ...
          <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
            <table class="table">
              <tbody>
                ...
                <tr>
                  <th>Price</th>
                  <td><i class="fa fa-inr" aria-hidden="true"></i> <span class="bid-price-{{$product->id}}">{{$product->amount_per_bid}}</span></td>
                </tr>
                <tr>
