                  ...
                  <tr>
                    <td class="product-in-table" style="display: flex;">
                      <img
                        ...
                        src="{{url('public/storage/'.$bidPack->image_path)}}"
                        style="height: 144px; width: 126px; margin-right: 10px"
                      />
                      <div class="product-it-in">
                        <h3>{{$bidPack->package_name}}</h3>
                        <span> You Will Get {{$bidPack->total_credit}} Bidderboy Credits.</span>
                      </div>
                    </td>
                    <td>₹{{$bidPack->cost}}</td>
                  </tr>
        ...
        <div class="col-md-4 order-md-2 mb-4">
          <ul class="list-group mb-3">
            <li class="list-group-item d-flex justify-content-between lh-condensed">
              ...
              <span class="text-muted">₹{{$bidPack->cost}}</span>
            </li>
            <li class="list-group-item d-flex justify-content-between lh-condensed">
              <div>
            ...
            <li class="list-group-item d-flex justify-content-between">
              <span>Total (INR)</span>
              <strong>₹<span id="grandTotal">{{$bidPack->cost}}</span></strong>
            </li>
          </ul>
          <a href="{{url('payment/ccavenue/'.$bidPack->id)}}" class="btn btn-sm btn-primary btn-block mb-1">INR - CCAvenue</a>
              ...
              <div class="col-md-8">
                  <form action="{{url(route('applyCoupon'))}}" class="card p-2" id="couponForm">
                    ...
                    <div class="input-group">
                      ...
                      <input type="hidden" name="cost" value="{{$bidPack->cost}}">
