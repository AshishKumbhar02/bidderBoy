                            ...
                            <div class="h-100"
                                ...
                                <div class="p-4 h-100 w-100 w-xl-50">
                                    ...
                                    <button class="btn btn-block border border-soft-light hov-bg-dark text-white mt-5 py-3"
                                        ...
                                        style="border-radius: 0px; background: rgba(255, 255, 255, 0.1);">
                                    ...
                                    <button onclick="copyInvitationLink()"
                                        class="btn  border  hov-bg-dark text-white mt-5 py-3" onclick="show_wallet_modal()"
                                        style="border-radius: 0px; background: rgba(255, 255, 255, 0.1);">
