                                ...
                                <div class="col-md-6">
                                    <form class="account_box" action="#" method="GET">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label"> Birthdate <span
                                                            class="text-danger">*</span>
                                                    </label>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                ...
                                                                placeholder="Auctions Participated" />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                name="auctions-won" placeholder="Auctions Won" />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label class="control-label"> Bidderboy Credits Used </label>
                                                            <input type="text" class="form-control"
                                                                name="credits-used"
                                                                placeholder="Bidderboy Credits Used" />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                name="credits-Bought"
                                                                placeholder="Bidderboy Credits Bought" />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label class="control-label"> Bidderboy Credits Left </label>
                                                            <input class="form-control" name="credits-left"
                                                                placeholder="Bidderboy Credits Left" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </form>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="passwordd"
                                                    ...
                                                    <div class="text-center">
                                                        <div class="form-group">
                                                            <button type="button" class="btn btn-info mrgleft10">Change
                                                                Password</button>
                                                        </div>
                                                    </div>
                                                </div>
