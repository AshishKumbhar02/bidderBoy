            ...
            <div class="aiz-user-panel">
                <div class="aiz-titlebar mb-4">
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            ...
                            <form method="post" action="{{route('profile.update_basic_profile_detail')}}" class="p-md-4 p-sm-2 manage-profile-form">
                                @csrf
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6 col-sm-12 p-2">
                                        ...
                                        <textarea id="address" name="address" rows="7" cols="50" class="form-control" placeholder="your address" required>{{$customer->address}}</textarea>
                                    </div>
                                      <div class="col-md-6 col-sm-12 p-2">
                ...
                <div class="card rounded-0 shadow-none border">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <a href="{{url('public/uploads/users/kyc_document/'.$customer->kyc_document)}}" target="_blank">View Document</a>
                        ...
                        <form action="{{route('profile.update_profile')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input type="file" class="form-control rounded-0" placeholder="Your Name" name="kyc_document" required>
                                </div>
                            </div>
                            <!-- Submit Button-->
                            <div class="form-group mb-0 text-right">
                                <button type="submit" class="btn btn-primary rounded-0 w-150px mt-3">Submit</button>
                            </div>
                        </form>
                        @endif
                    </div>
