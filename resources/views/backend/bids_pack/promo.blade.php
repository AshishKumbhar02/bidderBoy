        ...
        <div class="card bg-light-info shadow-none position-relative overflow-hidden">
            <div class="card-body px-4 py-3">
                <div class="row align-items-center">
                    <div class="col-9">
                        <h4 class="fw-semibold mb-8">Promo Code</h4>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a class="text-muted" href="{{ url('admin/dashboard') }}">Home</a>
                                </li>
                                <li class="breadcrumb-item" aria-current="page">Manage Promo Code</li>
                            </ol>
                        </nav>
                    </div>
                    <div class="col-3">
                        <div class="text-center mb-n5">
                            <a href="{{ route('product.add') }}" class="btn btn-primary btn-block" data-bs-toggle="modal"
                                ...
                                <tbody>
                                    ...
                                    @foreach ($bids_packs as $bids_pack)
                                        <tr>
                                            ...
                                            <td>
                                                <img src="{{ url('public/storage/' . $bids_pack->image_path) }}"
                                                    width="100px" height="100px">


                                            </td>
                                            <td>
                                                <a onclick="edit_bidspack('<?php echo $bids_pack->id; ?>')"
                                                    class="btn btn-primary btn-sm">Edit</a>
                                                <a href="{{ route('bids_packs.delete', $bids_pack->id) }}"
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.status === 'success' && response.data) {
                        ...
                        const editPackageModal = new bootstrap.Modal(document.getElementById(
                            "editPackageModal"));
