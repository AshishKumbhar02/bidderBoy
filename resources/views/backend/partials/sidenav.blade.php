...
<aside class="left-sidebar">
   ...
   <div>
      <div class="brand-logo d-flex align-items-center justify-content-between">
         ...
         <img src="{{url('assets/front/img')}}/logo.png" class="dark-logo" width="180" height="auto" alt="">
         <img src="{{url('assets/front/img')}}/logo.png" class="light-logo" width="180" height="auto" alt="" style="display: none;">
         </a>
      ...
      <nav class="sidebar-nav scroll-sidebar" data-simplebar="init">
                     ...
                     <div class="simplebar-content selected" style="padding: 0px 24px;">
                        <ul id="sidebarnav" class="in">
                           ...
                           <li class="sidebar-item @if(request()->segment(2) == 'customers' && request()->segment(3) == '') selected  @endif">
                              <a class="sidebar-link" href="{{url('admin/customers')}}" aria-expanded="false">
                              <span>
                           ...
                           <li class="sidebar-item @if(request()->segment(2) == 'auto_bid_customers' && request()->segment(3) == '') selected  @endif">
                              <a class="sidebar-link" href="{{url('admin/auto_bid_customers')}}" aria-expanded="false">
                              <span>
                              <i class="fa-solid fa-user-group"></i>
                              </span>
                           ...
                           <li class="sidebar-item @if(request()->segment(2) == 'customers' && request()->segment(3) == 'credits_list') selected  @endif">
                              <a class="sidebar-link" href="{{url('admin/customers/credits_list')}}" aria-expanded="false">
                              <span>
                              <i class="fa-solid fa-user-group"></i>
                              </span>
                           ...
                           <li class="sidebar-item @if(request()->segment(2) == 'frontend_settings') selected  @endif">
                              <a class="sidebar-link" href="{{url('admin/frontend_settings')}}" aria-expanded="false">
                              <span>
                           ...
                           <li class="sidebar-item @if(request()->segment(2) == 'business_settings') selected  @endif">
                              <a class="sidebar-link" href="{{url('admin/business_settings')}}" aria-expanded="false">
                              <span>
                              <i class="fa-solid fa-gear"></i>
                              </span>
                            ...
                            <li class="sidebar-item @if(request()->segment(2) == 'bids_packs') selected  @endif">
                              <a class="sidebar-link" href="{{url('admin/bids_packs')}}" aria-expanded="false">
                              <span>
         ...
         <div class="simplebar-track simplebar-vertical" style="visibility: visible;">
            <div class="simplebar-scrollbar" style="height: 91px; transform: translate3d(0px, 369px, 0px); display: block;"></div>
         </div>
      </nav>
      <div class="fixed-profile p-3 bg-light-secondary rounded sidebar-ad mt-3">
         <div class="hstack gap-3">
            <div class="john-img">
               <img src="{{url('assets/back/img')}}/user-1.jpg" class="rounded-circle" width="40" height="40" alt="">
            </div>
