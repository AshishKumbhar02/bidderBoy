...
<section class="account_section">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>1</td>
      <td>10</td>
      <td><i class="fa fa-inr" aria-hidden="true"></i> 20.00</td>
      <td>Active</td>
      <td>
        <a title="Edit" class="btn btn-warning btn-xs" href="#"><i class="fa fa-edit"></i></a>
        <a title="Delete" class="btn btn-danger btn-xs" href="#"><i class="fa fa-trash-o"></i></a>
      </td>
    </tr>
